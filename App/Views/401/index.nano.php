...
<!-- Post -->
    <article class="post">
        <header>
            <div class="title">
                <h2><a>401</a></h2>
                <p>Area restrita acesso não pertmitido.</p>
            </div>
            <div class="meta">
                <time class="published" datetime="<?=date("YY-M-d")?>"><?=getMounth();?> <?=date("d")?>, <?=date("Y")?></time>
                <a href="#" class="author"><span class="name">Admin</span><img src="<?=$_SERVER['assets'];?>img/avatar.jpg" alt="" /></a>
            </div>
        </header>
        <a  class="image featured"><img src="<?=$_SERVER['assets'];?>img/401.jpg" alt=""  style="z-index:0" tabindex=-1/></a>
        <footer>
            <ul class="actions">
                <li><a  href="./" class="button large" >Voltar</a></li>
            </ul>
            <ul class="stats">
...
<!-- Intro -->
    <section id="intro">
        ...
        <header>
            ...
            <p>Another fine responsive site template by <a >HTML5 UP</a></p>
        </header>
    </section>
