...
<!-- Post -->
    <article class="post">
        <header>
            <div class="title">
                ...
                <?php 
                        ...
                        {
                            echo "<p id='flask'>".$_SESSION['flask_message']."</p>";
                        }
                ?>
                <p class='flask'></p>
            </div>
        ...
        <form  class="image featured" id='form' method="POST" enctype="multipart/form-data">
            <input type="hidden" id="csrf" name="csrf" value="<?=$token->getCsrf();?>">
            <input type="hidden" id="signature" name="signature" value="<?=$token->getSignature();?>" >

            <div class="col-6 col-8-xsmall" style="padding-bottom:20px;padding-right: 10px;padding-left: 10px;">
                <input type="text" name="username" id="username" value="" placeholder="Email/Username" required/>
            </div>
            <div class="col-6 col-8-xsmall" style="padding-bottom:20px;padding-right: 10px;padding-left: 10px;">
                <input type="password" name="password" id="password" value="" placeholder="Senha" required/>
            </div>
            <div class="col-6 col-8-small" style="padding-bottom:20px;padding-right: 10px;padding-left: 10px;">
                <input type="checkbox" id="show" name="show" onchange="showPassword();">
                <label for="show">Mostrar senha</label>
            </div>
        </form>
        <footer>
            <ul class="actions">
                <li><button class="button large"  type="submit" onclick="document.getElementById('form').submit()">Login</button></li>
                <li><button class="button large" type="reset" onclick="document.getElementById('form').reset()" >Cancelar</button></li>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
        ...
        <section>
            ...
            <div class="box alt">
                <div class="row gtr-uniform">
                    <div class="col-12"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic02.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic04.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic05.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic06.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic06.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic04.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic05.jpg" alt="" /></span></div>
                    <div class="col-4"><span class="image fit"><img src="<?=$_SERVER['assets'];?>img/pic05.jpg" alt="" /></span></div>
...
<!-- Intro -->
    <section id="intro">
        ...
        <header>
            ...
            <p>Another fine resposnsive site template by <a >HTML5 UP</a></p>
        </header>
    </section>
